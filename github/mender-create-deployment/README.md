...
A GitHub action to create a deployment on a hosted Mender instance.
...
- `mender_devices_group`: the name of the devices group to which the release will be deployed
